...
set(PTOAS_TILE_LIB_BACKEND_EFFECTIVE "")
if(DEFINED PTOAS_TILE_LIB_BACKEND AND NOT PTOAS_TILE_LIB_BACKEND STREQUAL "")
    set(PTOAS_TILE_LIB_BACKEND_EFFECTIVE "${PTOAS_TILE_LIB_BACKEND}")
elseif(DEFINED ENV{PTOAS_TILE_LIB_BACKEND} AND NOT "$ENV{PTOAS_TILE_LIB_BACKEND}" STREQUAL "")
    set(PTOAS_TILE_LIB_BACKEND_EFFECTIVE "$ENV{PTOAS_TILE_LIB_BACKEND}")
endif()

if(NOT PTOAS_TILE_LIB_BACKEND_EFFECTIVE STREQUAL "")
    list(APPEND PTOAS_COMMAND "--tile-lib-backend=${PTOAS_TILE_LIB_BACKEND_EFFECTIVE}")
endif()
