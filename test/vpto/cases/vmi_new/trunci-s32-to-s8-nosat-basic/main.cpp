...
void LaunchVmi_trunci_s32_to_s8_nosat_basic_kernel(int32_t *src, int8_t *dst,
                                                   void *stream);

int main() {
  // 256 logical si32 lanes -> 256 packed si8 bytes.
  ...
  LaunchVmi_trunci_s32_to_s8_nosat_basic_kernel(srcDevice, dstDevice, stream);
