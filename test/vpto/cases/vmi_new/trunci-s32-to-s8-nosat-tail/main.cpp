...
int main() {
  // 1024 logical si32 lanes -> 1024 packed si8 bytes (last 24 sentineled).
  constexpr size_t kSrcElems = 1024;
  constexpr size_t kDstElems = 1024;
  size_t srcBytes = kSrcElems * sizeof(int32_t);
  ...
  LaunchVmi_trunci_s32_to_s8_nosat_tail_kernel(srcDevice, dstDevice, stream);
